              ...
              builder: (BuildContext context,
                ...
                if (currentMessages.isNotEmpty) {
                  ...
                  if (yorumlar.length == 0) {
                    return const Text("Hiç yorum yok");
                  }
...
Widget yanitlariGoster(
  ...
  return SingleChildScrollView(
    child: ListView.builder(
      ...
      itemBuilder: (context, index) {
        return ListTile(
          trailing: Text(yanitlar[yanitlar.length - 1 - index]['Response'] +
              "\n" +
              yanitlar[yanitlar.length - 1 - index]['Responser'] +
              "\n" +
              yanitlar[yanitlar.length - 1 - index]['ResponseTime']
                  .toDate()
                  .toString()
                  .substring(0, 10)),
        );
